...
public class TileManager {
    ...
    private void createTiles() {
        ...
        tiles.add(ROAD_TB = new Tile(ImgFix.getRotImg(getSprite(8, 0), 90), id++,
                "TB_Road"));
        tiles.add(ROAD_B_TO_R = new Tile(getSprite(7, 0), id++,
                "Road_Bottom_To_Right"));

        tiles.add(ROAD_L_TO_B = new Tile(ImgFix.getRotImg(getSprite(7, 0), 90), id++,
                "Road_Left_To_Bottom"));
        tiles.add(ROAD_L_TO_T = new Tile(ImgFix.getRotImg(getSprite(7, 0), 180),
                id++, "Road_Left_To_Top"));
        tiles.add(ROAD_T_TO_R = new Tile(ImgFix.getRotImg(getSprite(7, 0), 270),
                id++, "Road_Top_To_Right"));
        ...
        tiles.add(R_WATER = new Tile(ImgFix.getBuildRotImg(getImgs(0, 0, 6, 0), 90,
                1), id++, "R_Water"));
        tiles.add(B_WATER = new Tile(ImgFix.getBuildRotImg(getImgs(0, 0, 6, 0), 180,
                1), id++, "B_Water"));
        tiles.add(L_WATER = new Tile(ImgFix.getBuildRotImg(getImgs(0, 0, 6, 0), 270,
                1), id++, "L_Water"));

        tiles.add(TL_ISLE = new Tile(ImgFix.buildImg(getImgs(0, 0, 4, 0)), id++,
                "TL_Isle"));
        tiles.add(TR_ISLE = new Tile(ImgFix.getBuildRotImg(getImgs(0, 0, 4, 0), 90,
                1), id++, "TR_Isle"));
        tiles.add(BR_ISLE = new Tile(ImgFix.getBuildRotImg(getImgs(0, 0, 4, 0), 180,
                1), id++, "BR_Isle"));
        tiles.add(BL_ISLE = new Tile(ImgFix.getBuildRotImg(getImgs(0, 0, 4, 0), 270,
                1), id++, "BL_Isle"));
    }
